...
<script>
    export default {
        ...
        //----- Observador encargado de vigilar config y avisar cualquier cambio -----
        watch: {
            config: { //----- Aquí nos interesa selectedDevice -----
                immediate: true,
                deep: true, //----- Revisamos las anidaciones -----

                //----- Función disparada cuando config cambie en alguno de sus parámetros (dId, por ejemplo) -----
                handler() {
                    setTimeout(() => {
